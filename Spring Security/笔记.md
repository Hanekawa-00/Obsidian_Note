...
![assets/image-20230410140908841](assets/image-20230410140908841.png)
...
![assets/image-20231130152247055](assets/image-20231130152247055.png)

否则你的登录页会加载很久，并且看到的页面是这样的（登录按钮没有样式文件渲染，但是不影响登录功能的执行）

![assets/image-20231130152345471](assets/image-20231130152345471.png)
...
![assets/image-20231204230216259](assets/image-20231204230216259.png)
...
![assets/image-20231205164049257](assets/image-20231205164049257.png)
...
![assets/image-20231206022701725](assets/image-20231206022701725.png)
...
![assets/image-20231206023030864](assets/image-20231206023030864.png)
...
![assets/image-20230421184645177](assets/image-20230421184645177.png)
...
![assets/image-20231209011827867](assets/image-20231209011827867.png)
...
2. 客户应用（Client）：通常是一个Web或者无线**应用**，它需要访问用户的受保护资源。
...
![assets/image-20231222124053994](assets/image-20231222124053994.png)
...
![assets/image-20231222131233025](assets/image-20231222131233025.png)

##### 开放API

例如云冲印服务的实现

![assets/image-20231222131118611](assets/image-20231222131118611.png)

#### 现代微服务安全

##### 单块应用安全

![assets/image-20231222152734546](assets/image-20231222152734546.png)



##### 微服务安全

![assets/image-20231222152557861](assets/image-20231222152557861.png)
...
![assets/image-20231220180422742](assets/image-20231220180422742.png)



- 注册客户应用：客户应用如果想要访问资源服务器需要有凭证，需要在授权服务器上注册客户应用。注册后会**获取到一个ClientID和ClientSecrets**

![assets/image-20231222203153125](assets/image-20231222203153125.png)
...
​								![assets/image-20231220185958063](assets/image-20231220185958063.png)



![assets/image-20231222203218334](assets/image-20231222203218334.png)
...
![assets/image-20231220190152888](assets/image-20231220190152888.png)

![assets/image-20231222203240921](assets/image-20231222203240921.png)
...
![assets/image-20231222203259785](assets/image-20231222203259785.png)



### 1.5、授权类型的选择

![assets/image-20231223020052999](assets/image-20231223020052999.png)
...
![assets/image-20231223164128030](assets/image-20231223164128030.png)
...
![assets/image-20230510154255157](assets/image-20230510154255157.png)



填写应用信息：`默认的重定向URI模板为{baseUrl}/login/oauth2/code/{registrationId}`。registrationId是ClientRegistration的唯一标识符。

![assets/image-20231221000906168](assets/image-20231221000906168.png)

获取应用程序id，生成应用程序密钥：

![assets/image-20230510163101376](assets/image-20230510163101376.png)
...
![assets/image-20230510165314829](assets/image-20230510165314829.png)
...
![assets/image-20231223203225688](assets/image-20231223203225688.png)
